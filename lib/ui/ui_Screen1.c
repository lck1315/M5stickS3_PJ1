...
lv_obj_set_style_arc_color(ui_Spinner2, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_bg_color(ui_Panel2, lv_color_hex(0x5E50F7), LV_PART_MAIN | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_color(ui_MainText1, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT );
